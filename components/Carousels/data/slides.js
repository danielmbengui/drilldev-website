...
export const slides = photos.map(({ src, title, description, key, width, height, images }) => ({
  src,
  title,
  description,
  key,
...
export const advancedSlides = slides;
/*
export const advancedSlides = [
  { ...slides[0], description: <><span>{"Mollie Sivaram"}</span><button>Downloasd</button></> },
  {
    ...slides[1],
    title: "Miami Beach",
    description:
